...
class ReactImageLightbox extends Component {
    ...
    render() {
        ...
        const zoomInButtonClasses = ['toolbarItemChild', 'builtinButton', 'zoomInButton'];
        const zoomOutButtonClasses = ['toolbarItemChild', 'builtinButton', 'zoomOutButton'];
                ...
                >
                    ...
                    >
                        <ul
                            className={[
                                'ril-toolbar-left ',
                                (_ieVersion < 10 ? 'toolbarSide toolbarSideNoFlex ' : 'toolbarSide '),
                                (_ieVersion < 10 ? 'toolbarLeftSide toolbarLeftSideNoFlex' : 'toolbarLeftSide'),
                            ].join(' ')}
                        >
                        ...
                        <ul
                            className={[
                                'ril-toolbar-right',
                                (_ieVersion < 10 ? 'toolbarSide toolbarSideNoFlex' : 'toolbarSide'),
                                (_ieVersion < 10 ? 'toolbarRightSide toolbarRightSideNoFlex' : 'toolbarRightSide'),
                            ].join(' ')}
                        >
                            {!toolbarButtons ? '' : toolbarButtons.map((button, i) => (
                                <li key={i} className={'ril-toolbar__item toolbarItem'}>{button}</li>
                            ))}
                    ...
                    {this.props.imageCaption &&
                        ...
                        >
                            <div
                                className={'ril-caption-content captionContent'}
                            >
                                {this.props.imageCaption}
                            </div>
                        </div>
