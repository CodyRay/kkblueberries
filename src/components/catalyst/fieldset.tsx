...
export function Label({
  ...
  return (
    <Headless.Label
      ...
      className={clsx(
        className,
        "text-base/6 text-grey-950 select-none data-disabled:opacity-50 sm:text-sm/6 dark:text-white",
      )}
    />
  )
}
...
>) {
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        "text-base/6 text-grey-900 data-disabled:opacity-50 sm:text-sm/6 dark:text-grey-400",
      )}
    />
  )
}
