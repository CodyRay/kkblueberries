...
const styles = {
  ...
  outline: [
    // Base
    "border-grey-950/10 text-grey-950 data-active:bg-grey-950/2.5 data-hover:bg-grey-950/2.5",
    // Dark mode
    "dark:border-white/15 dark:text-white dark:[--btn-bg:transparent] dark:data-active:bg-white/5 dark:data-hover:bg-white/5",
    // Icon
    "[--btn-icon:var(--color-grey-500)] data-active:[--btn-icon:var(--color-grey-700)] data-hover:[--btn-icon:var(--color-grey-700)] dark:data-active:[--btn-icon:var(--color-grey-400)] dark:data-hover:[--btn-icon:var(--color-grey-400)]",
  ],
  plain: [
    // Base
  ...
  colors: {
    "dark/grey": [
      ...
      "dark:text-white dark:[--btn-bg:var(--color-grey-600)] dark:[--btn-hover-overlay:var(--color-white)]/5",
    ...
    "dark/white": [
      "text-white [--btn-bg:var(--color-grey-900)] [--btn-border:var(--color-grey-950)]/90 [--btn-hover-overlay:var(--color-white)]/10",
      "dark:text-grey-950 dark:[--btn-bg:white] dark:[--btn-hover-overlay:var(--color-grey-950)]/5",
      "[--btn-icon:var(--color-grey-400)] data-active:[--btn-icon:var(--color-grey-300)] data-hover:[--btn-icon:var(--color-grey-300)] dark:[--btn-icon:var(--color-grey-500)] dark:data-active:[--btn-icon:var(--color-grey-400)] dark:data-hover:[--btn-icon:var(--color-grey-400)]",
    ],
    dark: [
      "text-white [--btn-bg:var(--color-grey-900)] [--btn-border:var(--color-grey-950)]/90 [--btn-hover-overlay:var(--color-white)]/10",
    ...
    white: [
      "text-grey-950 [--btn-bg:white] [--btn-border:var(--color-grey-950)]/10 [--btn-hover-overlay:var(--color-grey-950)]/2.5 data-active:[--btn-border:var(--color-grey-950)]/15 data-hover:[--btn-border:var(--color-grey-950)]/15",
      "dark:[--btn-hover-overlay:var(--color-grey-950)]/5",
      "[--btn-icon:var(--color-grey-400)] data-active:[--btn-icon:var(--color-grey-500)] data-hover:[--btn-icon:var(--color-grey-500)]",
    ],
    grey: [
      "text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:var(--color-grey-600)] [--btn-border:var(--color-grey-700)]/90",
...
export const Button = forwardRef(function Button(
  ...
  let classes = clsx(
    ...
    outline
      ...
      : plain
        ? styles.plain
        : clsx(styles.solid, styles.colors[color ?? "dark/grey"]),
  )
