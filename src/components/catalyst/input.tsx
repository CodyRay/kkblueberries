  ...
  return (
    <span
      ...
      className={clsx(
        ...
        "*:data-[slot=icon]:text-grey-500 dark:*:data-[slot=icon]:text-grey-400",
      )}
    >
      {children}
    </span>
    ...
    >
      <Headless.Input
        ...
        className={clsx([
          ...
          // Disabled state
          "data-disabled:border-grey-950/20 dark:data-disabled:border-white/15 dark:data-disabled:bg-white/2.5 dark:data-hover:data-disabled:border-white/15",
          // System icons
          "dark:scheme-dark",
        ])}
      />
