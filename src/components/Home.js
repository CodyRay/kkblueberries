...
import rowsOfBlueberries from '../img/rows_of_blueberries.jpg'
import largeBlueberry from '../img/large_blueberries_one_sitting_on_nickle.jpg'
import twoBuckets from '../img/two_buckets_of_blueberries.jpg'
import packageBlueberries from '../img/package_of_blueberries.jpg'
...
export default () => (
  <div id="home" className="text-center">
    ...
    <span className="h4">$1.80 per pound </span>
    <p>
    ...
    <div className="kk-mt-20 kk-blue-box">
      ...
      <Link to="/info">our information page</Link> for common questions or give
      us a call at (541) 567-3146
    </div>
    <hr />
    <div className="row kk-center-vertical">
      <div className="col-md-8 col-sm-6">
        <h2>Pre-Ordering</h2>
        <p>
          You can pre-order flats of blueberries via email. Please contact us
