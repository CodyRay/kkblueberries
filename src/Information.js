...
export default () => (
  <div id="about">
    ...
    <ul>
      ...
      <li>
        Absolutely no outside animals are allowed on the farm.
        </li>
    </ul>
    ...
    <p>
      We close mid-day from 11am to 5pm because when the temperature rises the berries become too soft for picking. We may also close on days with high temperature. The quickest way to get updates on picking is to call the phone number for information before you drive out here.
        </p>
    ...
    <h1>Where can I find recipe ideas and nutritional information about blueberries?</h1>
    <p>
      <a href="http://www.oregonblueberry.com" rel="noopener noreferrer" target="_blank">Oregon Blueberries</a> has recipes blueberry cheesecake, blueberry french toast, blueberry smoothies, and more. They also have <a href="http://www.oregonblueberry.com/nutrition.html" rel="noopener noreferrer" target="_blank">detailed nutrition information</a> on blueberries.
        </p>
  </div>
);