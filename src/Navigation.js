        ...
        <div className='navbar-collapse'>
          {(() => {
            ...
            const LiNavLink = ({ to, exact, ...rest }) => (
              <Route path={to.pathname} exact={exact}
            ...
            return (
              <ul className="nav navbar-nav navbar-right" >
                <LiNavLink exact to={{ pathname: '/' }}>
                  <span className="kk-icon-lg-green icon-leaves" />Home
                    </LiNavLink>
                <LiNavLink exact to={{ pathname: '/info' }}>
                  <span className="kk-icon-lg-green icon-leaves" />Information
                    </LiNavLink>
                <LiNavLink exact to={{ pathname: '/photos' }}>
                  <span className="kk-icon-lg-green icon-leaves" />Photos
                    </LiNavLink>
              </ul>)
          })()}
        </div>
